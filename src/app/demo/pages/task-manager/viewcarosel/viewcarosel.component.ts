...
@Component({
  selector: 'app-viewcaroselna',
  templateUrl: './viewcarosel.component.html',
  styleUrls: ['./viewcarosel.component.scss']
})
export class ViewcaroselComponent implements OnInit {
...
showtable: any;
  ...
  getcolumnname(field, tnameorac) {
    ...
    // var i=1;
    // if(field.indexOf("CONSOL_PROFIT")>-1){
    //      i=2;
    // }
    // let a = field.replace('INSERTING on FBNK_', '');
    ...
    Object.keys(arg0)
      .reduce((obj, key) => {
        try {
          ...
          count = count + Object.keys(arg0[key]).length;
        } catch (error) {
