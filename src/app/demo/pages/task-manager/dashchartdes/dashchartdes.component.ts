...
@Component({
  selector: 'app-dashchartdes',
  templateUrl: './dashchartdes.component.html',
  styleUrls: ['./dashchartdes.component.scss']
})
export class DashchartdesComponent implements OnInit {
